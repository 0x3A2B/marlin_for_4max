...
#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define MAX_AUTORETRACT 15.0            // Upper limit for auto-retract conversion
  #define RETRACT_LENGTH 6                // Default retract length (positive mm)
  #define RETRACT_LENGTH_SWAP 15          // Default swap retract length (positive mm), for extruder change
  #define RETRACT_FEEDRATE 70             // Default feedrate for retracting (mm/s)
  #define RETRACT_ZLIFT 0                 // Default retract Z-lift
  #define RETRACT_RECOVER_LENGTH 0.2        // Default additional recover length (mm, added to retract length when recovering)
  #define RETRACT_RECOVER_LENGTH_SWAP 0.2   // Default additional swap recover length (mm, added to retract length when recovering from extruder change)
